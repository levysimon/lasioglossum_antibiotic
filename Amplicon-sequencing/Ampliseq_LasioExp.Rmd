...
p1 <- ggplot(mdf, aes(x = SampleID, y = CopyNum)) +
    ...
    scale_y_log10(limits=c(1,1e10), breaks = c(1e1, 1e2, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9)) +
    coord_cartesian(ylim = c(1e3,1e9)) +
    # Added space = "free_x" here to unify bar widths
...
p_sig_pairs <- ggplot(df_plot, aes(x = Treatment, y = log_cop)) +
  ...
  # Points plus transparents (alpha = 0.4)
  geom_jitter(aes(color = Replicate_num), width = 0.35, alpha = 0.4, size = 2) +
