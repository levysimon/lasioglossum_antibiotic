...
## Master Visualization: Behavior & Activity
...
p5 <- plot_fun(df_move, model_avg.speed, "antibiotic", "average.speed", "reinoculation", "Avg Speed [cm/sec]", is_lmm=TRUE, row=1)
p6 <- plot_fun(df_move, model_beta, "antibiotic", "prop_time_adj", "reinoculation", "Prop. Time Moving", is_perc=TRUE, row=2)
