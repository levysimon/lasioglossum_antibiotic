...
# On compare "yes" vs "no" au sein de chaque dose (Seulement 3 comparaisons !)
pairs(emm, by = "antibiotic", adjust = "tukey")
...
model_gauss_low <- lmer(mean.dist ~ antibiotic * reinoculation + (1 | year),data = df_interind_reduced)
...
### additive model
```{r}
model_gauss_low_add <- lmer(mean.dist ~ antibiotic + reinoculation + (1 | year),data = df_interind_reduced)
